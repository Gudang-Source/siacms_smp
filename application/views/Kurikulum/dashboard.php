...
<head>
  ...
  <!-- AdminLTE Skins. Choose a skin from the css/skins
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>/assets/admin/chosen/chosen.min.css">
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?php echo site_url('kurikulum');?>" class="logo">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo site_url('kurikulum/profile');?>" class="btn btn-default btn-flat">Profile</a>
                </div>
...
if (@$persentase == TRUE) {
  ...
  <script type="text/javascript">
    Highcharts.chart('visitor', {
      ...
      title: {
            text: 'Grafik Kehadiran Pegawai Tahun 2018'
        },
       tooltip: {
