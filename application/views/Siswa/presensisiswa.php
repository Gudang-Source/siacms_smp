      ...
      if (($this->session->userdata("jabatan") == "Kurikulum") || ($this->session->userdata("jabatan") == "Guru")|| ($this->session->userdata("jabatan") == "Karyawan") ) {
        ?>
                  <div class="posisikanan">
                    ...
                    <select name="tahun" id="tahun" onchange="document.location='<?php echo site_url('penilaian/akademik/presensi'); ?>/'+document.getElementById('pilihkelaspresensi').value+'/'+document.getElementById('tahun').value+'/'+document.getElementById('bulan').value;">
                      <option value="2017" <?php if ($thn == '2017') { echo " selected"; } ?>>2017</option>
                      <option value="2018" <?php if ($thn == '2018') { echo " selected"; } ?>>2018</option>
                    </select>
                  </div>
                  <br/><br/>
                  <form method="post" action="<?php echo site_url('penilaian/akademik/simpanpresensi'); ?>">
...
<div class="box-body">
  ...
  <!-- /.box-body -->
      ...
      <div class="tab-pane" id="imporpresensi">
             <form class="form-horizontal formmapel" action="<?php echo base_url('penilaian/akademik/importpresensi'); ?>" method="post" enctype="multipart/form-data">
