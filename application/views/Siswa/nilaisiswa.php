              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <form method="post" action="<?php echo base_url('penilaian/tambah_nilai'); ?>" onsubmit="return ceknilai();">
                    <select id="pilihkelastambah" onchange="document.location='<?php echo site_url('penilaian/akademik/nilaisiswa'); ?>/'+document.getElementById('pilihkelastambah').value+'/'+document.getElementById('pilihmapeltambah').value;">
                    ...
                    <select name="mapel" id="pilihmapeltambah" onchange="document.location='<?php echo site_url('penilaian/akademik/nilaisiswa'); ?>/'+document.getElementById('pilihkelastambah').value+'/'+document.getElementById('pilihmapeltambah').value;">
                      ...
                      foreach ($mapel as $x){
                        ...
                        <option value="<?php echo $x->id_mapel;?>" <?php if ($id_mapel == $x->id_mapel) { echo " selected"; } ?>><?php echo $x->nama; echo $x->jenjang?></option>
                        <?php
                      }?></select>
                ...
                <button type="button" class="pull-right btn-jdwl" onclick="document.location='<?php echo site_url('penilaian/akademik/exportnilai/'.@$this->uri->segment(3).'/'.@$this->uri->segment(4)); ?>/'+document.getElementById('katnilai').value+'/'+document.getElementById('jenis_na').value;">Export</button>
          ...
          <div class="bigbox-mapel"> 
            <div class="box-mapel">
                  ...
                  <div class="col-md-12">
                    ...
                    <select nama="id_kelas_reguler_berjalan2" id="imporkelasnilai" onchange="document.location='<?php echo site_url('penilaian/akademik/nilaisiswa'); ?>/'+document.getElementById('imporkelasnilai').value+'/'+document.getElementById('impormapel').value;">
                      <option value="">Pilih Kelas</option>
                      <?php
                    ...
                    <select name="id_mapel2" id="impormapel" onchange="document.location='<?php echo site_url('penilaian/akademik/nilaisiswa'); ?>/'+document.getElementById('imporkelasnilai').value+'/'+document.getElementById('impormapel').value;">
            ...
            <div class="active tab-pane" id="daftar">
              ...
              <select id="pilihkelasnilai" onchange="document.location='<?php echo site_url('penilaian/akademik/nilaisiswa'); ?>/'+document.getElementById('pilihkelasnilai').value+'/'+document.getElementById('pilihmapelnilai').value;">
                <option value="">Pilih Kelas</option>
                <?php
              ...
              <select id="pilihmapelnilai" onchange="document.location='<?php echo site_url('penilaian/akademik/nilaisiswa'); ?>/'+document.getElementById('pilihkelasnilai').value+'/'+document.getElementById('pilihmapelnilai').value;">
                <option value="" >Pilih Mapel</option>
                <?php
               ...
               <div class="tab-pane" id="leger">
                <div class="box">
                 ...
                 <div class="box-body">
                  <option value=""></option>
                  <select id="pilihkelasledger" onchange="document.location='<?php echo site_url('penilaian/akademik/nilaisiswa'); ?>/'+document.getElementById('pilihkelasledger').value;">
                    <?php
                    foreach ($kelas_reguler_berjalan as $d){
                      ?>
                            ...
                            <thead>
                              <tr>
                                ...
                                foreach ($mapel as $rowmapel) {
                                  ?>
                                  <th colspan="2"><?php echo $rowmapel->nama; ?></th>
                                  <?php
                                }
                                ?>
