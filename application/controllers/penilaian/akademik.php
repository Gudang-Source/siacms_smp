...
class Akademik extends CI_Controller{
  function __construct(){
    ...
    $this->load->view('siswa/penilaian_footer');   
  }
  function index(){
  ...
  public function nilaisiswa(){
    ...
    $this->template->load('siswa/dashboard','siswa/nilaisiswa',$data);
}
...
//    $kaldik = $this->M_data->getkaldik($tahunajaran->tanggal_mulai, $tahunajaran->tanggal_selesai);
    ...
    $this->template->load('siswa/dashboard','siswa/kaldik', $data);
  }
  ...
  function kurikulum(){
    ...
    $this->template->load('siswa/dashboard','siswa/kurikulum',$data);
  }
  ...
  public function form_edit_kurikulum(){
    ...
    $this->load->view('penilaian/edit/edit_kurikulum',$data);
  }
...
function presensi() {
  ...
  $this->template->load('siswa/dashboard','siswa/presensisiswa',$data);
}
...
redirect('penilaian/akademik/presensi');
